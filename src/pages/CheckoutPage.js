...
function CheckoutPage() {
    ...
    return ( 
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 shadow-xl">
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between gap-x-6 py-5 border-2 border-solid border-gray-200 px-5">
